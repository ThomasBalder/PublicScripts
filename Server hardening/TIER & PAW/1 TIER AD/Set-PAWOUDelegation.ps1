...
$userAccountsOU = "OU=User Accounts,OU=contoso,"
$workstationsOU = "OU=Workstations,OU=contoso,"
$computerQuarantineOU = "OU=Computer Quarantine,OU=contoso,"
$tier1ServersOU = "OU=Tier 1 Servers,OU=contoso,"
$PAWDevicesOU = "OU=Devices,OU=Tier 0,OU=Admin,OU=contoso,"


# Set variables for Group objects
$serviceDeskOperatorsGroup = "ServiceDeskOperators"
$workstationMaintenanceGroup = "Tier2admins"
$replicationMaintenanceGroup = "Tier0ReplicationMaintenance"
$tier1ServerMaintenanceGroup = "Tier1admins"
...
#Set Workstation admins Permissions on Computers to access BitLocker and TPM information
#Add-Log -LogEntry("Performing workstation admins Role Delegations to the Workstation OU");
$workstationsOUACL.AddAccessRule((New-Object System.DirectoryServices.ActiveDirectoryAccessRule `
            $workstationMaintSID, "ReadProperty", "Allow", $guidmap["msTPM-OwnerInformation"], "Descendents", $guidmap["computer"]))
$workstationsOUACL.AddAccessRule((New-Object System.DirectoryServices.ActiveDirectoryAccessRule `
            $workstationMaintSID, "ReadProperty", "Allow", $guidmap["msFVE-KeyPackage"], "Descendents", $guidmap["msFVE-RecoveryInformation"]))
$workstationsOUACL.AddAccessRule((New-Object System.DirectoryServices.ActiveDirectoryAccessRule `
            $workstationMaintSID, "ReadProperty", "Allow", $guidmap["msFVE-RecoveryPassword"], "Descendents", $guidmap["msFVE-RecoveryInformation"]))
$workstationsOUACL.AddAccessRule((New-Object System.DirectoryServices.ActiveDirectoryAccessRule `
            $workstationMaintSID, "ReadProperty", "Allow", $guidmap["msFVE-VolumeGuid"], "Descendents", $guidmap["msFVE-RecoveryInformation"]))
