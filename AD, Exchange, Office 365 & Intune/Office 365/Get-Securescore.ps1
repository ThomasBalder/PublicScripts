...
.AUTHOR 
GCITS (https://gcits.com/knowledge-base/export-customers-microsoft-secure-scores-to-csv-and-html-reports/)
...
- Global admin account in target tenant

.INSTRUCTIONS
- Modify lines 24, 26, 34, 35 to you liking. Optional for single tenant: comment out line 231 & 232.
...
$yourLogo = "https://spinnakertraders.nl/wp-content/uploads/2019/12/spinnakertraders-logo.svg"
$TableHeaderColour = "#00a1f1"
$applicationName = "Secure Score Exporter"
...
$homePage = "https://spinnakertraders.nl"
$appIdURI = "https://secure.spinnakertraders.nl/$((New-Guid).ToString())"
