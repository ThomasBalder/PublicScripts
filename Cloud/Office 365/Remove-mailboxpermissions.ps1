...
#Start logging
Start-Transcript -Path "c:\temp\Remove-MailboxPermissions.log" -Force
Write-Host "The logs of this process are written to c:\temp\Remove-MailboxPermissions.log" -ForegroundColor Magenta
...
Invoke-item "c:\temp\Remove-MailboxPermissions.log"
